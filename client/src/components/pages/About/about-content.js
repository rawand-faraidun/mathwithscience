    ...
    articles: [
        {
            ...
            articleWritings: [
                ...
                {
                    en: `with Math with Science, You can calculate some of your math problems in only a few seconds. 
        ...
        },
        {
            ...
            articleWritings: [
                {
                    en: `The idea of this website goes back to 2019, As a student I had many issues with math, 
                        althrough I really loved it, But sometimes it got out of my control. I got the idea right in math class as I said 
                    ...
                    kr: `بیرۆکەی ئەم وێبسایتە بۆ ساڵی ٢٠١٩ ئەگەڕێتەوە، وەک خوێندکارێک زۆرجار کێشەم هەبوو لەگەڵ بیرکاری،
                        لەگەڵ ئەوەشدا کە زۆرم حەز لێیە، بەڵام هەندێک جار لە کۆنترۆڵی من دەرئەچێت. بیرۆکەکەم لە ناوەڕاستی وانەی بیرکاری بۆ هات کاتێ بیرمکردەوە
                        "یارمەتی ئەوانە بدەم کە هەمان پرسیارەکانی منیان هەیە".`
                },
                {
                    en: `After finishing my first semister. I started to think about it more and I gathered information some about the function of some math calculations.
                        then I started to build them slowly, Then I got help from my friends 'Mhamad Rzgar', 'Shazyar Taha', & 'Mhamad Hassan'.`,
                    kr: `دوای سەرکەوتنم لە قۆنا‌غی یەکەمی زانکۆ، زیاتر بیرم لێئەکردەوە و زانیاریم کۆکردەوە دەرباری کردارەکانی هەندێک ژمێرەری بیرکاری.
                        دواتر هەستام بە درووستکردنیان بە هێواشی، پاشان هاوڕێکانم 'محەمەد ڕزگار'، 'شازیار تەها'، و 'معەمەد حەسەن'.`
                },
                {
                    en: `After a few months we brought the idea to life and you can use it, Althrough it won't solve much math problems, 
                        but together we try our bests to improve it`,
        ...
        },
        {
            ...
            articleWritings: [
                {
                    en: 'As a small group, We may not be too fast, but with your help we can get improvement in a better and a faster way.',
                    kr: 'وەک گروپێکی بچووک، لەوانەیە ئێمە خێرا نەبین، بەڵام بە یارمەتی ئێوە ئەتوانین بەرەوپێش بچین بە شێوازێکی باشتر و خێرا تر.'
                },
                {
                    en: `So we are asking for your help in two ways, one is by sending us your ideas for new feautrues and calculators,
                        second one is by helping us with the programming, we made the project "Open Source" to get support from anyone who can code with JavaScript.
                        read more from Contribute page`,
                    kr: `بۆیە ئێمە داوای یارمەتی لە ئێوە ئەکەین بە دوو شێواز، یەکەمیان بە مێشنیار کردنی بیرۆکەکانتان بۆ تایبەتمەندی و ژێمرەری نوێ،
                ...
                {
                    en: "Your support is highly apreciated, even if you can't help us with that we still apreciate that you use our website، enjoy it.",
                    kr: 'یارمەتی ئێوە زۆر بەرز ئەنرخێنیە، تەنانەت ئەگەر یارمەتیشمان نەدەیت ئێمە هەر سوپاسگوزارین بۆ بەکارهێنانی وێبسایتەکەمان'
                },
            ]
        },
    ],
